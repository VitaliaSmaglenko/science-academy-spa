...
export default {
  ...
  get: (id) => {
    return { data: { data:
          { id: id, work: { id: 1, name: 'Керівництво студентів з підготовкою тез доповідей на міжнародних конференціях' }, title: 'Бібліографічне описання', reference: 'Посилання', number_of_hours: 12, season: 'Весна', created_at: new Date(2019, 11, 24) }
    } }
  },
